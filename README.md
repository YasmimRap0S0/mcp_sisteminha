...
O **Sisteminha** facilita a busca de desenvolvedores para microempreendedores que desejam adquirir sistemas personalizados para seus negócios.
...
- [Orientações para os desenvolvedores](doc/guia-ds/guia.md)  

---

# 🚀 Guia de Instalação e Execução do MCP com o Sisteminha

Este guia mostra como preparar o ambiente, rodar o servidor MCP e integrar com o Claude Desktop.
...
- Banco de dados populado e respondendo via API.  
